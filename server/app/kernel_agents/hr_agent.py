...
class HrAgent(BaseAgent):
    ...
    def __init__(
        ...
        super().__init__(
            agent_name=agent_name if agent_name is not None else AgentType.HR.value,
        ...
        **kwargs,
        ...
        try:
            ...
            agent_definition = await cls._create_azure_ai_agent_definition(
                agent_name=agent_name if agent_name is not None else AgentType.HR.value,
                instructions=system_message if system_message is not None else cls.default_system_message(agent_name),
                temperature=0.0,
