...
from app.kernel_agents.generic_agent import GenericAgent
from app.orchestrator.group_chat_manager import GroupChatManager
# Import all specialized agent implementations
from app.kernel_agents.hr_agent import HrAgent
from app.kernel_agents.human_agent import HumanAgent
from app.kernel_agents.marketing_agent import MarketingAgent
from app.kernel_agents.planner_agent import PlannerAgent  # Add PlannerAgent import
from app.kernel_agents.procurement_agent import ProcurementAgent
from app.kernel_agents.product_agent import ProductAgent
from app.kernel_agents.tech_support_agent import TechSupportAgent
from app.kernel_agents.info_agent import InfoAgent
from app.kernel_agents.patient_context_agent import PatientContextAgent
from app.kernel_agents.action_agent import ActionAgent
from app.models.messages_kernel import AgentType, PlannerResponsePlan
...
class AgentFactory:
    ...
    _agent_classes: Dict[AgentType, Type[BaseAgent]] = {
        ...
        AgentType.INFO_AGENT: InfoAgent,
        AgentType.PATIENT_CONTEXT_AGENT: PatientContextAgent,
        AgentType.ACTION_AGENT: ActionAgent,
        AgentType.AGENT_BASE: BaseAgent,  # Fallback to BaseAgent if type is unknown
    }
